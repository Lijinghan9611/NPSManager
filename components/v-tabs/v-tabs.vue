<template>
	<view :id="elId" class="v-tabs">
		<scroll-view id="scrollContainer" :scroll-x="scroll" :scroll-left="scroll ? scrollLeft : 0"
			:scroll-with-animation="scroll" :style="{ position: fixed ? 'fixed' : 'relative', zIndex: 1 }">
			<view class="v-tabs__container" :style="{
				...
				<view :class="['v-tabs__container-item', { disabled: !!v.disabled }, { 'current-item': current == i }]"
